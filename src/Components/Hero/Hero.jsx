      ...
      <div className="relative min-h-screen w-full overflow-hidden bg-gradient-to-b from-[#0a0a1f] via-[#151532] to-[#1a1a3e]">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 md:px-8 text-center">
          ...
          <div className="flex flex-row gap-4 justify-center w-full max-w-sm">
            ...
            <Link
              to="/projects"
              className="group w-auto px-6 py-3 bg-transparent border border-yellow-500 rounded-full text-white font-bold text-sm sm:text-base flex justify-center items-center gap-2 hover:bg-yellow-500 hover:text-white hover:shadow-lg hover:shadow-red-500/50 transition-all hover:scale-105"
            >
