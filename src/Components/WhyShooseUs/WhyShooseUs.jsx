...
import { Lightbulb, Target, ArrowRight, Play } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-950 py-20 px-4 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="hidden lg:grid lg:grid-cols-2 gap-12 items-start text-left">
          {/* Left Column - Feature Cards (كان على اليمين) */}
          <div className="space-y-8 text-left order-first lg:order-first">
            ...
            <div className="space-y-6 text-left">
              {/* Card 1 */}
              <div className="rounded-2xl p-6 border border-slate-700/50 hover:border-blue-500/50 transition-all duration-300 text-left bg-slate-800/40 backdrop-blur-sm">
          ...
          {/* Right Column - Big Card (كان على اليسار) */}
          <div className="relative order-last lg:order-last">
            <div className="rounded-3xl p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden bg-slate-900/40 backdrop-blur-sm">
        ...
        {/* Mobile/Tablet Layout (يبقى كما هو) */}
        <div className="lg:hidden space-y-8 text-left">
          ...
          <div className="space-y-6 px-4 text-left">
            <div className="rounded-2xl p-6 border border-slate-700/50 bg-slate-800/40 backdrop-blur-sm">
